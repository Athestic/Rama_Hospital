      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PatientRegistrationForm1()),
            );
          },
...
class PatientRegistrationForm1 extends StatefulWidget {
  @override
  _PatientRegistrationFormState createState() =>
      _PatientRegistrationFormState();
}

class _PatientRegistrationFormState extends State<PatientRegistrationForm1> {
  ...
  Future<void> _registerPatient() async {
    final url = Uri.parse('${AppConfig.apiUrl1}${AppConfig.patientRegistrationAppEndpoint}');
